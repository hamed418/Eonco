    ...
    <div className='bg-[rgb(25, 25, 25)] sm:bg-none'>
      <div className={`flex flex-row w-[95%] sm:min-h-fit  m-auto pt-6 justify-between items-center`}>
        ...
        <div className={`sm:min-h-fit min-h-[30vh]  absolute flex flex-col items-center sm:flex-row w-full sm:w-auto sm:static ${open ? `top-[-100%]` : `top-[8%]`} ${open ? `rgb(10, 10, 10)` : `bg-black left-0 pt-3`} `}>
          ...
          <a className='text-[17px] p-4 uppercase text-[#ebe1e1] hover:bg-[#4c4b4a43] rounded-sm duration-200 font-[500] cursor-pointer'
            onClick={(e) => {
              e.preventDefault()
              document.getElementById('process').scrollIntoView({ behavior: 'smooth' })
            }}
          >Our Process</a>
          <a className='text-[17px] p-4 uppercase text-[#ebe1e1] hover:bg-[#4c4b4a43] rounded-sm duration-200 font-[500] cursor-pointer' onClick={(e) => {
            e.preventDefault();
        ...
        <div className='text-[22px] font-bold'>Eonco Digital</div>
        <div>
